<div class="main-panel">
            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Ordered Processing</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © all right reserved here
                2023</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a
                    href="https://www.codingduckblogportfolio.xyz/" target="_blank">Developed by
                    </a> Md.Makbul Hosen</span>
        </div>
    </footer>
    <!-- partial -->
</div>
